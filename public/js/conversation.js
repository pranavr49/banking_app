...
function transferMoney(){	
	...
	var context = latestResponse.context;
	 Api.sendRequest("Transfer Money", context);
}
function billPay(){	
	var latestResponse = Api.getResponsePayload();
	var context = latestResponse.context;
	 Api.sendRequest("Bill Pay", context);
}
function addPayee(){	
	var latestResponse = Api.getResponsePayload();
	var context = latestResponse.context;
	 Api.sendRequest("Add New Payee", context);
}
function proceed(){	
	var latestResponse = Api.getResponsePayload();
	var context = latestResponse.context;
...
function submitPayee(benf_name, benf_actno){	
	var latestResponse = Api.getResponsePayload();
	var context = latestResponse.context;
	context.benf_name = benf_name;
	context.benf_actno = benf_actno;
	Api.sendRequest("Proceed Payee", context);
	console.log(benf_name);
}
